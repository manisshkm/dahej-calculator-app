    ...
    <footer className="bg-gray-900 text-white py-8 mt-12">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="text-center md:text-left mb-4 md:mb-0">
          <h2 className="text-xl font-bold">Dahej Calculator</h2>
          <p className="text-sm text-gray-400">Spreading awareness with a touch of humor.</p>
        </div>
        ...
        <div className="flex space-x-4 text-2xl">
          ...
          <a href="km9474789@gmail.com" className="hover:text-yellow-400">
            <FaEnvelope />
          </a>
        </div>
      </div>
      ...
      <div className="mt-6 text-center text-sm text-gray-500">
        &copy; {new Date().getFullYear()} Dahej Calculator. All rights reserved.
      </div>
    </footer>
  );
};
